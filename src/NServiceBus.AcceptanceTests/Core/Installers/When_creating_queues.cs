namespace NServiceBus.AcceptanceTests.Installers
{
    ...
    {
        [Test]
        public async Task Should_not_create_queues_queue_creation_disabled_and_installers_disabled()
        {
        ...
        [Test]
        public async Task Should_not_create_queues_queue_creation_disabled_and_installers_enabled()
        {
            var context = await Scenario.Define<Context>(c =>
                {
                    c.DoNotCreateQueues = true;
        ...
        [Test]
        public async Task Should_not_create_queues_queue_creation_enabled_and_installers_disabled()
        {
            var context = await Scenario.Define<Context>(c =>
                {
        ...
        [Test]
        public async Task Should_create_queues_queue_creation_enabled_and_installers_enabled()
        {
            var context = await Scenario.Define<Context>(c =>
                {
                    c.DoNotCreateQueues = false;
